...
export const SignUpScreen = ({ onComplete, onLogin, onboardingData }) => {
  ...
  const canSubmit = emailValid && strength >= 2 && !loading;
  ...
  const savings = React.useMemo(() => {
    ...
    const dailyCost = (cigs / cigsPerPack) * pricePerPack;
      ...
      <div className="signup__right">
        ...
        <form onSubmit={handleSubmit}>
          <div className="signup__fields">
            <div className="signup__field">
              ...
              <input
                ...
                className={`signup__field-input${email && !emailValid ? ' signup__field-input--error' : email && emailValid ? ' signup__field-input--success' : ''}`}
                autoComplete="email"
              />
              {email && !emailValid && (
                <div className="signup__field-hint signup__field-hint--warn">Verifique o formato do e-mail</div>
              )}
            </div>
          ...
          <div className="signup__security">
            <Icon name="Lock" size={14} color="var(--color-primary)" style={{ flexShrink: 0, marginTop: 1 }} />
